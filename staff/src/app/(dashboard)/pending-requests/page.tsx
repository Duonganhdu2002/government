...
import PendingDetailPopup from "@/components/common/PendingDetailPopup";
...
const PendingRequestsPage = () => {
  const [selectedRequest, setSelectedRequest] = useState<null | typeof pendingRequests[0]>(null);


  return (
    <div className="h-full p-5 md:p-6 lg:p-8 bg-white rounded-lg shadow-sm overflow-auto">
      <Text className="text-xl font-bold text-black mb-4">Yêu cầu chờ duyệt</Text>
      <Text className="text-md font-semibold text-red-500 mb-2">
        Danh sách các yêu cầu đang chờ phê duyệt
      </Text>
      <Table>
        <Table.Header>
          <Table.Row>
            ...
            <Table.HeaderCell className=" font-bold">Ngày nộp</Table.HeaderCell>
