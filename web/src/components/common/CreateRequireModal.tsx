...
// CreateRequireModal: Modal component for creating a new order/request
const CreateRequireModal = () => {
  ...
  return (
    <FocusModal>
      ...
      <FocusModal.Content className="z-50">
        ...
        <DialogTitle asChild>
          <VisuallyHidden>TẠO ĐƠN MỚI</VisuallyHidden>
        </DialogTitle>
        <DialogDescription asChild>
          <VisuallyHidden>
            Nhập thông tin để tạo đơn yêu cầu mới.
          </VisuallyHidden>
        </DialogDescription>

        {/* Modal Header: Title and Submit button */}
        <FocusModal.Header className="flex justify-between items-center">
          <Heading>TẠO ĐƠN MỚI</Heading>
          <Button>Nộp</Button>
        </FocusModal.Header>

        {/* Modal Body: Contains form elements arranged in a grid */}
        <FocusModal.Body className="p-4 overflow-y-auto h-full">
          <div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-3 md:gap-4 h-full">
...
export default CreateRequireModal;
